...
function desenhar_tabela_usuario()
{
    ...
    echo "<div class='row'><section class='col-6 order-0'><div class='row'>
    <div class='col-6'>
   ...
   <p>{$key['nome']}</p>
    ...
    <section class='col-6 order-1'>
    <div class='row'>
    <div class='col-8'><i class='bi bi-person-plus-fill' alt='foto de perfil' style='font-size:100px'></i></div></div>
    <div class='row'><div class='col-6'><a role='button' class='btn btn-outline-primary' href='pagfoto.php?id=" . $key['id'] . "'> Adicionar Foto    
    </a></div></div>
    </section></div>
    <div class='col-3'>
