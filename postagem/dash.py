...
df2 = pd.read_csv('analysis_data_2.csv')

# Ler a URL das imagens dos arquivos
with open("img_url.txt", "r") as f:
    img_url_post1 = f.read().strip()

with open("img_url_2.txt", "r") as f:
    img_url_post2 = f.read().strip()

# Carregar imagens das postagens
imagem_post1 = carregar_imagem(img_url_post1)
imagem_post2 = carregar_imagem(img_url_post2)
